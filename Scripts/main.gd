...
func _audio_setup() -> void:
	...
	_ensure_sfx("clear_board_cast", "res://Assets/Audio/clear.wav", -14.0)
	...
	_ensure_sfx("freeze_cast", "res://Assets/Audio/Skills/Freeze/freeze_cast.ogg", -16.0)
	_ensure_sfx("safe_well_cast", "res://Assets/Audio/Skills/SafeWell/safewell_cast.ogg", -17.0)
	_ensure_sfx("safe_well_doors_open", "res://Assets/Audio/Skills/SafeWell/doors_open.ogg", -18.0)
	_ensure_sfx("safe_well_doors_close", "res://Assets/Audio/Skills/SafeWell/doors_close.ogg", -18.0)
	_ensure_sfx("safe_well_lock_clink", "res://Assets/Audio/Skills/SafeWell/lock_clink.ogg", -19.0)
