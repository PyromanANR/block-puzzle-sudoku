...
func _audio_setup() -> void:
	...
	_ensure_sfx("skill_freeze", "res://Assets/Audio/Skills/Freeze/freeze_cast.ogg", -20.0)
	_ensure_sfx("skill_safe_well", "res://Assets/Audio/Skills/SafeWell/skill_safe_well.wav", -44.0)
